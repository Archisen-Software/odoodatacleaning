...
input_file = 'C:\\Users\\User\\Downloads\\sale.order (9).xlsx'
...
channel_dict = {
    ...
    "(Orchird Country Club) NTUC Fairprice Co-operative Ltd": "Fairprice Darkstores",
    "NTUC Fairprice Co-operative Ltd":	"Fairprice",
    "Delivery Hero Stores (Whampoa)": 	"PandaMart",
    "Delivery Hero Stores (Outram)":	"PandaMart",
    "Delivery Hero Stores (Serangoon)":	"PandaMart",
    "Delivery Hero Stores (Tampines)":	"PandaMart", 
    "Delivery Hero Stores (Redhill)":	"PandaMart",
    "Urban Tiller Pte Ltd":	"Urban Tiller",
    "AVE23 Pte Ltd, OpenTaste":	"OpenTaste",
    "Agrivo Mycosciences Pte Ltd":	"Mushroom Kingdom",
